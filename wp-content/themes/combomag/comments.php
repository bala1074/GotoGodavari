...
<div id="rssfeed"><a title="<?php __('stay updated with', TEMPLATE_DOMAIN); ?> <?php the_title_attribute(); ?>" href="<?php echo home_url() ?>/?feed=rss2&amp;p=<?php the_ID(); ?>"><?php _e('Subscribe to comments feed', TEMPLATE_DOMAIN); ?></a></div>
</div>
